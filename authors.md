...
- **Christina Maimone**. Reviewer.

- **Niels Ohlsen**. Reviewer.

- **Douglas Ezra Morrison**. Contributor.
...
Source:
[`inst/CITATION`](https://github.com/easystats/parameters/blob/v0.28.3/inst/CITATION)
