...
Thanks for using [parameters](https://easystats.github.io/parameters/).
...
- If you’re not sure: let’s
  [discuss](https://github.com/easystats/parameters/discussions) it and
  try to figure it out! If your problem *is* a bug or a feature request,
  you can easily return here and report it.

Before opening a new issue, be sure to [search issues and pull
requests](https://github.com/easystats/parameters/issues) to make sure
