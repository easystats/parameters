...
#' @param dof Degrees of Freedom. If not specified, for `ci_wald()`, defaults to model's residual degrees of freedom (i.e. `n-k`, where `n` is the number of observations and `k` is the number of parameters). For `p_value_wald()`, defaults to `Inf`.
#'
