...
#' \itemize{
#'  \item{\link[parameters:standardize.data.frame]{Dataframes}}
#'  \item{\link[parameters:standardize.lm]{Regression models}}
#'  }
#'
#'
#' @param x An object.
...
#' @param method The method of standardization. For data.frames, can be \code{"default"} (variables are divided by SD or MAD depending on \code{robust}) or \code{"2sd"} (divided by two times the deviation). For models, check \link[parameters:standardize.lm]{corresponding documentation}.
