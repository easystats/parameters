...
```
    ...
    # Parameter                                  | Coefficient |   SE |       95% CI |     t |     p | Coefficient (std.)
    # -------------------------------------------------------------------------------------------------------------------
    # (Intercept)                                |        1.78 | 0.91 | -0.01,  3.57 |  1.95 | 0.05  |              -0.24
    # Petal.Length * Petal.Width                 |        0.28 | 0.24 | -0.20,  0.76 |  1.16 | > .1  |               0.30
    # (Sepal.Width * Petal.Length) * Petal.Width |       -0.05 | 0.08 | -0.20,  0.10 | -0.61 | > .1  |               1.57
    # Petal.Width                                |       -2.04 | 1.52 | -5.02,  0.94 | -1.34 | > .1  |              -0.43
    # Petal.Length                               |        0.88 | 0.50 | -0.09,  1.85 |  1.77 | 0.08  |              -0.15
    # Sepal.Width                                |        0.75 | 0.27 |  0.22,  1.28 |  2.80 | < .01 |               0.07
    # Sepal.Width * Petal.Width                  |        0.34 | 0.49 | -0.62,  1.30 |  0.70 | > .1  |               0.22
    # Sepal.Width * Petal.Length                 |       -0.10 | 0.16 | -0.42,  0.21 | -0.63 | > .1  |              -0.03
