...
Finally, the `to_table()` allows to format the output in markdown-format, to create pretty rendered table inside markdown documents. These tables also look great when knitting markdown-documents into Word or PDF.
