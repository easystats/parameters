...
[`demean()`](https://easystats.github.io/parameters/reference/demean.html)
...
```{r echo=FALSE}
ggplot(d, aes(x, y)) +
  see::geom_point_borderless(colour = "#555555", size = 2.5, alpha = .5) +
  see::theme_modern() +
...
```{r echo=FALSE}
ggplot(d, aes(x, y)) +
  see::geom_point_borderless(mapping = aes(colour = grp), size = 2.5, alpha = .5) +
  geom_smooth(method = "lm", se = F, colour = "#555555") +
...
ggplot(d, aes(x, y)) +
  ...
  see::geom_point_borderless(mapping = aes(colour = grp), size = 2.2, alpha = .6) +
  see::scale_color_flat() +
  see::theme_modern() +
  labs(x = "Typing Speed", y = "Typing Errors", colour = "Type Experience")
```
