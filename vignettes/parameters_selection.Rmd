---
title: "Variable selection (stepwise, projpred, ...)"
output: 
  github_document:
    toc: true
    fig_width: 10.08
...
vignette: >
  %\VignetteIndexEntry{Variable selection (stepwise, projpred, ...)}
...
Altough appealing, please note that these automated selection methods are [**quite citicized**](https://towardsdatascience.com/stopping-stepwise-why-stepwise-selection-is-bad-and-what-you-should-use-instead-90818b3f52df), and should not be used in place of **theorethical** or **hypothetical** reasons (*i.e.*, you should have justified hypotheses about the parameters of your model).
