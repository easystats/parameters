...
But still though, look at that **gorgeous R2! 0.882!** *I wish I had that in my research...*
...
Time to do some variables selection. This can be easily done using the `parameters_selection()` function.
...
This gave us a formula containing the best parameters. One way of using that is in a tidy pipeline (using [`%>%`](https://cran.r-project.org/web/packages/magrittr/README.html)), using this output to update a new model.
