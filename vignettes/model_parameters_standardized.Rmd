...
There are different methods of standardizing model
parameters (see
[`?effectsize::standardize_parameters`](https://easystats.github.io/effectsize/reference/standardize_parameters.html)for
further details)):
- `"refit"`,
- `"posthoc"`
- `"smart"` 
