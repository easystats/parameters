...
`model_parameters()` works fine with Bayesian models from the **rstanarm**
package...
...
... as well as for (more complex) models from the **brms** package. For more
complex models, other model components can be printed using the arguments
`effects` and `component` arguments.
