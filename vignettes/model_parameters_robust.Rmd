...
`sandwich::vcovHC(type = "HC3")`). We would extract model parameters both with
and without robust estimation to highlight difference it makes to standard
errors, confidence intervals, and *p*-values. Also, note that the coefficient estimate and the statistic associated with it remain unchanged.
