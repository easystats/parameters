...
[`cor.test`](https://rdrr.io/r/stats/cor.test.html)`(``iris``$``Sepal.Length``, ``iris``$``Sepal.Width``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
...
\
[`t.test`](https://rdrr.io/r/stats/t.test.html)`(``mpg`` ``~`` ``vs``, data ``=`` ``mtcars``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
...
\
`BayesFactor``::`[`correlationBF`](https://rdrr.io/pkg/BayesFactor/man/correlationBF.html)`(``iris``$``Sepal.Length``, ``iris``$``Sepal.Width``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
...
\
`BayesFactor``::`[`ttestBF`](https://rdrr.io/pkg/BayesFactor/man/ttestBF.html)`(``formula ``=`` ``mpg`` ``~`` ``vs``, data ``=`` ``mtcars``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
`#> Bayesian t-test`\
`#> `\
`#> Parameter  | Median |          95% CI |     pd |              Prior |     BF`\
...
\
[`aov`](https://rdrr.io/r/stats/aov.html)`(``Sepal.Length`` ``~`` ``Species``, data ``=`` ``iris``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``es_type ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"omega"``, ``"eta"``, ``"epsilon"``)``)`\
...
\
[`aov`](https://rdrr.io/r/stats/aov.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Sepal.Width``, data ``=`` ``iris``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(`\
`    es_type ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"omega"``, ``"eta"``)``,`\
`    ci ``=`` ``0.8`\
`  ``)`\
...
\
[`aov`](https://rdrr.io/r/stats/aov.html)`(``mpg`` ``~`` ``am`` ``+`` ``Error``(``gear``)``, data ``=`` ``mtcars``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
`#> # gear`\
`#> `\
...
\
[`glm`](https://rdrr.io/r/stats/glm.html)`(``vs`` ``~`` `[`poly`](https://rdrr.io/r/stats/poly.html)`(``mpg``, ``2``)`` ``+`` ``cyl``, data ``=`` ``mtcars``, family ``=`` `[`binomial`](https://rdrr.io/r/stats/family.html)`(``)``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
...
[`glm`](https://rdrr.io/r/stats/glm.html)`(``vs`` ``~`` `[`poly`](https://rdrr.io/r/stats/poly.html)`(``mpg``, ``2``)`` ``+`` ``cyl``, data ``=`` ``mtcars``, family ``=`` `[`binomial`](https://rdrr.io/r/stats/family.html)`(``)``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``exponentiate ``=`` ``TRUE``, ci_method ``=`` ``"wald"``)`\
...
[`glm`](https://rdrr.io/r/stats/glm.html)`(``vs`` ``~`` `[`poly`](https://rdrr.io/r/stats/poly.html)`(``mpg``, ``2``)`` ``+`` ``cyl``, data ``=`` ``mtcars``, family ``=`` `[`binomial`](https://rdrr.io/r/stats/family.html)`(``)``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``exponentiate ``=`` ``TRUE``, include_info ``=`` ``TRUE``)`\
`#> Parameter        | Odds Ratio |       SE |            95% CI |     z |     p`\
`#> ----------------------------------------------------------------------------`\
...
\
[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(``Sepal.Width`` ``~`` ``Petal.Length`` ``+`` ``(``1`` ``|`` ``Species``)``, data ``=`` ``iris``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
`#> # Fixed Effects`\
`#> `\
...
\
[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(``Sepal.Width`` ``~`` ``Petal.Length`` ``+`` ``(``1`` ``|`` ``Species``)``, data ``=`` ``iris``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``effects ``=`` ``"fixed"``)`\
`#> # Fixed Effects`\
`#> `\
`#> Parameter    | Coefficient |   SE |       95% CI | t(146) |      p`\
`#> ------------------------------------------------------------------`\
...
`model`` ``<-`` `[`mixed_model`](https://drizopoulos.github.io/GLMMadaptive/reference/mixed_model.html)`(`\
`  ``count`` ``~`` ``spp`` ``+`` ``mined``,`\
`  random ``=`` ``~`` ``1`` ``|`` ``site``,`\
`  zi_fixed ``=`` ``~`` ``spp`` ``+`` ``mined``,`\
`  family ``=`` `[`zi.negative.binomial`](https://drizopoulos.github.io/GLMMadaptive/reference/extra_fams.html)`(``)``,`\
`  data ``=`` ``Salamanders`\
`)`\
...
`  ``dat`` ``<-`` `[`expand.grid`](https://rdrr.io/r/base/expand.grid.html)`(``fac ``=`` `[`factor`](https://rdrr.io/r/base/factor.html)`(``letters``[``1``:``nfac``]``)``, t ``=`` ``1``:``nt``)`\
`  ``n`` ``<-`` `[`nrow`](https://rdrr.io/r/base/nrow.html)`(``dat``)`\
`  ``dat``$``REfac`` ``<-`` `[`rnorm`](https://rdrr.io/r/stats/Normal.html)`(``nfac``, sd ``=`` ``facsd``)``[``dat``$``fac``]`\
`  ``dat``$``REt`` ``<-`` `[`rnorm`](https://rdrr.io/r/stats/Normal.html)`(``nt``, sd ``=`` ``tsd``)``[``dat``$``t``]`\
`  ``dat``$``x`` ``<-`` `[`rnorm`](https://rdrr.io/r/stats/Normal.html)`(``n``, mean ``=`` ``mu``, sd ``=`` ``residsd``)`` ``+`` ``dat``$``REfac`` ``+`` ``dat``$``REt`\
`  ``dat`\
`}`\
\
[`set.seed`](https://rdrr.io/r/base/Random.html)`(``101``)`\
...
[`stan_glm`](https://mc-stan.org/rstanarm/reference/stan_glm.html)`(``mpg`` ``~`` ``wt`` ``*`` ``cyl``, data ``=`` ``mtcars``, refresh ``=`` ``0``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
`#> Parameter   | Median |          95% CI |     pd |  Rhat | ESS (tail) |                   Prior`\
`#> ----------------------------------------------------------------------------------------------`\
`#> (Intercept) |  52.86 | [ 40.98, 63.96] |   100% | 1.003 |       1410 | Normal (20.09 +- 15.07)`\
`#> wt          |  -8.09 | [-12.44, -3.72] | 99.88% | 1.002 |       1549 |  Normal (0.00 +- 15.40)`\
`#> cyl         |  -3.58 | [ -5.47, -1.63] | 99.98% | 1.002 |       1279 |   Normal (0.00 +- 8.44)`\
`#> wt:cyl      |   0.73 | [  0.11,  1.33] | 98.58% | 1.003 |       1464 |   Normal (0.00 +- 1.36)`
...
`model`` ``<-`` `[`suppressWarnings`](https://rdrr.io/r/base/warning.html)`(`[`brm`](https://paulbuerkner.com/brms/reference/brm.html)`(`\
`  `[`bf`](https://paulbuerkner.com/brms/reference/brmsformula.html)`(`\
`    ``count`` ``~`` ``persons`` ``+`` ``child`` ``+`` ``camper`` ``+`` ``(``1`` ``|`` ``persons``)``,`\
`    ``zi`` ``~`` ``child`` ``+`` ``camper`` ``+`` ``(``1`` ``|`` ``persons``)`\
`  ``)``,`\
`  data ``=`` ``fish``,`\
`  family ``=`` `[`zero_inflated_poisson`](https://paulbuerkner.com/brms/reference/brmsfamily.html)`(``)``,`\
`  refresh ``=`` ``0`\
`)``)`\
...
\
[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``, component ``=`` ``"conditional"``, verbose ``=`` ``FALSE``)`\
`#> # Fixed Effects`\
`#> `\
...
\
`psych``::`[`pca`](https://rdrr.io/pkg/psych/man/principal.html)`(``mtcars``, nfactors ``=`` ``3``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
...
\
`FactoMineR``::`[`FAMD`](https://rdrr.io/pkg/FactoMineR/man/FAMD.html)`(``iris``, ncp ``=`` ``3``, graph ``=`` ``FALSE``)`` ``|>`\
`  `[`parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
...
\
`model`` ``<-`` ``lavaan``::`[`cfa`](https://rdrr.io/pkg/lavaan/man/cfa.html)`(``" visual  =~ x1 + x2 + x3`\
`                       textual =~ x4 + x5 + x6`\
`                       speed   =~ x7 + x8 + x9 "``,`\
...
`)`\
\
[`rma`](https://wviechtb.github.io/metafor/reference/rma.uni.html)`(``yi ``=`` ``effectsize``, sei ``=`` ``standarderror``, method ``=`` ``"REML"``, data ``=`` ``mydat``)`` ``|>`\
`  `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``)`\
