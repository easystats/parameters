...
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Petal.Length``, data ``=`` ``iris``)`\
...
\
`mp`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``)`\
[`print`](https://rdrr.io/r/base/print.html)`(``mp``, pretty_names ``=`` ``FALSE``)`\
...
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``neg_c_7`` ``~`` ``e42dep`` ``+`` ``c172code``, data ``=`` ``efc``)`\
\
`# default printing`\
[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``)`\
...
`mp`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``)`\
[`print`](https://rdrr.io/r/base/print.html)`(``mp``, pretty_names ``=`` ``"labels"``)`\
`#> Parameter                                 | Coefficient |   SE |         95% CI`\
`#> -------------------------------------------------------------------------------`\
...
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Petal.Length``, data ``=`` ``iris``)`\
\
`result`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``)`\
\
...
[`print`](https://rdrr.io/r/base/print.html)`(``result``, select ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"Parameter"``, ``"SE"``, ``"p"``)``)`\
`#> Parameter                           |   SE |      p`\
`#> ---------------------------------------------------`\
`#> (Intercept)                         | 0.41 | < .001`\
...
`model`` ``<-`` `[`glmmTMB`](https://rdrr.io/pkg/glmmTMB/man/glmmTMB.html)`(``count`` ``~`` ``spp`` ``+`` ``mined`` ``+`` ``(``1`` ``|`` ``site``)``,`\
`  ziformula ``=`` ``~`` ``spp`` ``+`` ``mined``,`\
`  family ``=`` `[`nbinom2`](https://rdrr.io/pkg/glmmTMB/man/nbinom2.html)`(``)``,`\
`  data ``=`` ``Salamanders`\
`)`\
[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``)`\
...
[`print`](https://rdrr.io/r/base/print.html)`(``mp``, split_component ``=`` ``FALSE``, table_width ``=`` ``Inf``)`\
`#> # Fixed Effects`\
`#> `\
...
\
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Petal.Length``, data ``=`` ``iris``)`\
[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``, include_info ``=`` ``TRUE``)`\
`#> Parameter                           | Coefficient |   SE |         95% CI`\
`#> -------------------------------------------------------------------------`\
`#> (Intercept)                         |        4.21 | 0.41 | [ 3.41,  5.02]`\
`#> Species [versicolor]                |       -1.81 | 0.60 | [-2.99, -0.62]`\
...
[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``, include_reference ``=`` ``TRUE``)`\
...
[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``, digits ``=`` ``4``)`\
...
\
[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``, p_digits ``=`` ``"scientific"``)`\
`#> Parameter            | Coefficient |   SE |       95% CI | t(147) |            p`\
`#> --------------------------------------------------------------------------------`\
...
[`levels`](https://rdrr.io/r/base/levels.html)`(``Salamanders``$``spp``)`` ``<-`` `[`paste`](https://rdrr.io/r/base/paste.html)`(``"long"``, `[`levels`](https://rdrr.io/r/base/levels.html)`(``Salamanders``$``spp``)``)`\
\
...
\
`mp`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``)`\
[`print`](https://rdrr.io/r/base/print.html)`(``mp``, column_width ``=`` ``"fixed"``)`\
`#> # Fixed Effects (Count Model)`\
`#> `\
`#> Parameter            | Log-Mean |   SE |         95% CI |     z |      p`\
`#> ------------------------------------------------------------------------`\
...
\
[`print`](https://rdrr.io/r/base/print.html)`(``mp``, column_width ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``SE ``=`` ``8``` , `95% CI`  ```=`` ``12``, p ``=`` ``7``)``)`\
`#> # Fixed Effects (Count Model)`\
`#> `\
`#> Parameter        | Log-Mean |       SE |         95% CI |     z |       p`\
`#> -------------------------------------------------------------------------`\
...
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``mpg`` ``~`` ``hp`` ``+`` ``gear`` ``*`` ``vs`` ``+`` ``cyl`` ``+`` ``drat``, data ``=`` ``mtcars``)`\
\
`# don't select "Intercept" parameter`\
`mp`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``, drop ``=`` ``"^\\(Intercept"``)`\
\
`# inspect data frame`\
[`as.data.frame`](https://rdrr.io/r/base/as.data.frame.html)`(``mp``)`\
...
[`print`](https://rdrr.io/r/base/print.html)`(``mp``, groups ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`\
`  Engine ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``5``, ``6``, ``4``, ``1``)``,`\
`  Interactions ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``8``, ``9``)``,`\
`  Controls ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``2``, ``3``, ``7``)`\
`)``)`\
...
\
`# group parameters, either by parameter name or position`\
[`print`](https://rdrr.io/r/base/print.html)`(``mp``,`\
`  sep ``=`` ``"  "``,`\
`  groups ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`\
`    Engine ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``5``, ``6``, ``4``, ``1``)``,`\
`    Interactions ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``8``, ``9``)``,`\
`    Controls ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``2``, ``3``, ``7``)`\
`  ``)`\
...
`lm3`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Petal.Length``, data ``=`` ``iris``)`\
[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``lm1``, ``lm2``, ``lm3``)`\
...
\
[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``lm1``, ``lm2``, ``lm3``, select ``=`` ``"se_p"``)`\
`#> Parameter                           |            lm1 |             lm2 |             lm3`\
`#> ----------------------------------------------------------------------------------------`\
...
[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``lm1``, ``lm2``, ``lm3``, select ``=`` ``"{estimate}{stars} ({se})"``)`\
`#> Parameter                           |            lm1 |             lm2 |             lm3`\
`#> ----------------------------------------------------------------------------------------`\
`#> (Intercept)                         | 5.01*** (0.07) |  3.68*** (0.11) |  4.21*** (0.41)`\
`#> Species [versicolor]                | 0.93*** (0.10) | -1.60*** (0.19) | -1.81 ** (0.60)`\
...
[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``lm1``, ``lm2``, ``lm3``, select ``=`` ``"{estimate} ({ci_low}, {ci_high}), p={p}{stars}"``)`\
`#> Parameter                           |                           lm1`\
`#> -------------------------------------------------------------------`\
...
`result`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``lm3``)`\
[`print`](https://rdrr.io/r/base/print.html)`(``result``, select ``=`` ``"{estimate}{stars} ({ci})"``)`\
...
[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(`\
`  ``lm1``, ``lm2``, ``lm3``,`\
`  column_names ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"First Model"``, ``"Second Model"``, ``"Third Model"``)`\
`)`\
...
\
[`library`](https://rdrr.io/r/base/library.html)`(`[`glmmTMB`](https://github.com/glmmTMB/glmmTMB)`)`\
[`data`](https://rdrr.io/r/utils/data.html)`(``"fish"``)`\
\
`m0`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``count`` ``~`` ``child`` ``+`` ``camper``, data ``=`` ``fish``, family ``=`` `[`poisson`](https://rdrr.io/r/stats/family.html)`(``)``)`\
\
`m1`` ``<-`` `[`glmmTMB`](https://rdrr.io/pkg/glmmTMB/man/glmmTMB.html)`(`\
`  ``count`` ``~`` ``child`` ``+`` ``camper`` ``+`` ``(``1`` ``|`` ``persons``)`` ``+`` ``(``1`` ``|`` ``ID``)``,`\
`  data ``=`` ``fish``,`\
`  family ``=`` `[`poisson`](https://rdrr.io/r/stats/family.html)`(``)`\
`)`\
\
`m2`` ``<-`` `[`glmmTMB`](https://rdrr.io/pkg/glmmTMB/man/glmmTMB.html)`(`\
`  ``count`` ``~`` ``child`` ``+`` ``camper`` ``+`` ``zg`` ``+`` ``(``1`` ``|`` ``ID``)``,`\
`  ziformula ``=`` ``~`` ``child`` ``+`` ``(``1`` ``|`` ``persons``)``,`\
`  data ``=`` ``fish``,`\
`  family ``=`` `[`truncated_poisson`](https://rdrr.io/pkg/glmmTMB/man/nbinom2.html)`(``)`\
`)`\
\
[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``m0``, ``m1``, ``m2``, effects ``=`` ``"all"``, component ``=`` ``"all"``)`\
`#> # Fixed Effects`\
`#> `\
`#> Parameter   |                   m0 |                   m1 |                   m2`\
`#> --------------------------------------------------------------------------------`\
...
\
`cp`` ``<-`` `[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``m0``, ``m1``, ``m2``, effects ``=`` ``"all"``, component ``=`` ``"all"``)`\
[`print`](https://rdrr.io/r/base/print.html)`(``cp``, column_width ``=`` ``"fixed"``)`\
`#> # Fixed Effects`\
`#> `\
`#> Parameter               |                   m0 |                   m1 |                   m2`\
`#> --------------------------------------------------------------------------------------------`\
...
\
`lm1`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``+`` ``Petal.Length``, data ``=`` ``iris``)`\
`lm2`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Width`` ``~`` ``Species`` ``*`` ``Petal.Length``, data ``=`` ``iris``)`\
\
`# remove intercept`\
`cp`` ``<-`` `[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``lm1``, ``lm2``, drop ``=`` ``"^\\(Intercept"``)`\
\
`# look at parameters names, to know their names for "groups" argument`\
[`as.data.frame`](https://rdrr.io/r/base/as.data.frame.html)`(``cp``)``$``Parameter`` ``# note the unicode char as interaction mark`\
...
[`print`](https://rdrr.io/r/base/print.html)`(``cp``, groups ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(`\
`  Species ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
`    ``"Species [versicolor]"``,`\
`    ``"Species [virginica]"`\
`  ``)``,`\
`  Interactions ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(`\
...
`lm2`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``+`` ``Petal.Length``, data ``=`` ``iris``)`\
`lm3`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Petal.Length``, data ``=`` ``iris``)`\
`lm4`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Sepal.Length`` ``~`` ``Species`` ``*`` ``Petal.Length`` ``+`` ``Petal.Width``, data ``=`` ``iris``)`\
\
`# very wide table`\
[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``lm1``, ``lm2``, ``lm3``, ``lm4``)`\
`#> Parameter                           |               lm1 |                  lm2`\
`#> ------------------------------------------------------------------------------`\
...
`tab`` ``<-`` `[`compare_parameters`](https://easystats.github.io/parameters/reference/compare_parameters.md)`(``lm1``, ``lm2``, ``lm3``, ``lm4``)`\
[`print`](https://rdrr.io/r/base/print.html)`(``tab``, table_width ``=`` ``80``)`\
`#> Parameter                           |               lm1 |                  lm2`\
`#> ------------------------------------------------------------------------------`\
`#> (Intercept)                         | 5.01 (4.86, 5.15) |  3.68 ( 3.47,  3.89)`\
`#> Species [versicolor]                | 0.93 (0.73, 1.13) | -1.60 (-1.98, -1.22)`\
