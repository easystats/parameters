...
[`check_heteroscedasticity`](https://easystats.github.io/performance/reference/check_heteroscedasticity.html)`(``model``)`\
...
`mp`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``, vcov ``=`` ``"HC3"``)`\
`mp`\
`#> Parameter   | Coefficient |   SE |          95% CI | t(48) |      p`\
`#> -------------------------------------------------------------------`\
...
`mp``$``SE`\
`#> [1] 5.93 0.43`\
[`unname`](https://rdrr.io/r/base/unname.html)`(`[`sqrt`](https://rdrr.io/r/base/MathFun.html)`(`[`diag`](https://rdrr.io/r/base/diag.html)`(``sandwich``::`[`vcovHC`](https://zeileis.codeberg.page/sandwich/reference/vcovHC.html)`(``model``)``)``)``)`\
`#> [1] 5.93 0.43`
...
`model`` ``<-`` `[`lm`](https://rdrr.io/r/stats/lm.html)`(``Petal.Length`` ``~`` ``Sepal.Length`` ``*`` ``Species`` ``+`` ``Sepal.Width``, data ``=`` ``iris``)`\
\
`# change estimation-type`\
`mp`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(`\
`  ``model``,`\
`  vcov ``=`` ``"CL"``, ``# type of covariance matrix`\
`  vcov_args ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``type ``=`` ``"HC1"``)`` ``# type of robust estimation`\
`)`\
\
`mp`\
...
[`unname`](https://rdrr.io/r/base/unname.html)`(`[`sqrt`](https://rdrr.io/r/base/MathFun.html)`(`[`diag`](https://rdrr.io/r/base/diag.html)`(``sandwich``::`[`vcovCL`](https://zeileis.codeberg.page/sandwich/reference/vcovCL.html)`(``model``)``)``)``)`\
`#> [1] 0.422 0.111 0.653 0.587 0.079 0.123 0.111`
...
\
`iris``$``cluster`` ``<-`` `[`factor`](https://rdrr.io/r/base/factor.html)`(`[`rep`](https://rdrr.io/r/base/rep.html)`(``LETTERS``[``1``:``8``]``, length.out ``=`` `[`nrow`](https://rdrr.io/r/base/nrow.html)`(``iris``)``)``)`\
\
`# change estimation-type, defining additional arguments`\
`mp`` ``<-`` `[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(`\
`  ``model``,`\
`  vcov ``=`` ``"vcovCL"``,`\
`  vcov_args ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``type ``=`` ``"HC1"``, cluster ``=`` ``iris``$``cluster``)`\
`)`\
\
`mp`\
`#> Parameter                           | Coefficient |   SE |        95% CI`\
...
[`unname`](https://rdrr.io/r/base/unname.html)`(`[`sqrt`](https://rdrr.io/r/base/MathFun.html)`(`[`diag`](https://rdrr.io/r/base/diag.html)`(``sandwich``::`[`vcovCL`](https://zeileis.codeberg.page/sandwich/reference/vcovCL.html)`(``model``, cluster ``=`` ``iris``$``cluster``)``)``)``)`\
`#> [1] 0.337 0.072 0.519 0.264 0.072 0.097 0.051`
...
`  ``model``,`\
`  vcov ``=`` ``"vcovCR"``,`\
`  vcov_args ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``type ``=`` ``"CR1"``, cluster ``=`` ``iris``$``cluster``)`\
`)`\
`mp`\
`#> Parameter                           | Coefficient |   SE |        95% CI`\
`#> ------------------------------------------------------------------------`\
...
\
[`unname`](https://rdrr.io/r/base/unname.html)`(`[`sqrt`](https://rdrr.io/r/base/MathFun.html)`(`[`diag`](https://rdrr.io/r/base/diag.html)`(``clubSandwich``::`[`vcovCR`](http://jepusto.github.io/clubSandwich/reference/vcovCR.md)`(``model``, type ``=`` ``"CR1"``, cluster ``=`` ``iris``$``cluster``)``)``)``)`\
`#> [1] 0.330 0.070 0.508 0.259 0.071 0.095 0.050`
...
[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.md)`(``model``, standardize ``=`` ``"refit"``, vcov ``=`` ``"HC3"``)`\
`#> Parameter                           | Coefficient |   SE |         95% CI`\
`#> -------------------------------------------------------------------------`\
...
`iris``$``grp`` ``<-`` `[`as.factor`](https://rdrr.io/r/base/factor.html)`(`[`sample`](https://rdrr.io/r/base/sample.html)`(``1``:``3``, `[`nrow`](https://rdrr.io/r/base/nrow.html)`(``iris``)``, replace ``=`` ``TRUE``)``)`\
\
`# fit example model`\
`model`` ``<-`` ``lme4``::`[`lmer`](https://rdrr.io/pkg/lme4/man/lmer.html)`(`\
...
`  ``model``,`\
`  vcov ``=`` ``"vcovCR"``,`\
`  vcov_args ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``type ``=`` ``"CR1"``, cluster ``=`` ``iris``$``grp``)`\
`)`\
`#> # Fixed Effects`\
`#> `\
`#> Parameter                          | Coefficient |   SE |         95% CI`\
