...
Thanks for using `{parameters}`. Before filing an issue, there are a few places
...
Armed with your reprex, the next step is to figure out where to ask:
  ...
  * If you're not sure: let's [discuss](https://github.com/easystats/parameters/discussions) it and try to figure it out! If your
    problem _is_ a bug or a feature request, you can easily return here and
    report it.

Before opening a new issue, be sure to [search issues and pull requests](https://github.com/easystats/parameters/issues) to make sure the
