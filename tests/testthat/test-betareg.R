if (require("testthat") &&
  ...
  test_that("ci", {
    expect_equal(
      ci(m1)$CI_low,
      c(-6.51692, 1.52932, 1.09151, 1.34475, 0.85909, 0.93085, 0.83233,
  ...
  test_that("se", {
    expect_equal(
      ...
      c(0.18232, 0.10123, 0.1179, 0.1161, 0.10236, 0.10352, 0.10604,
  ...
  test_that("model_parameters", {
    expect_equal(
      ...
      c(-6.15957, 1.72773, 1.3226, 1.57231, 1.05971, 1.13375, 1.04016,
