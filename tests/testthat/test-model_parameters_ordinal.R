...
if (.runThisTest &&
  ...
  d <- data.frame(
    Stim = c("New", "New", "New", "New", "New", "New",
             "Old", "Old", "Old", "Old", "Old", "Old"),
    Response = c("Confidence1", "Confidence2", "Confidence3", "Confidence4",
  ...
  test_that("model_parameters.clm", {
    ...
    expect_equal(
      mp$Parameter,
      c("Confidence1|Confidence2", "Confidence2|Confidence3", "Confidence3|Confidence4",
