...
test_that("include_response | (g)lm", {
  ...
  expect_equal(par_z2$Std_Coefficient, c(NA, 4.78199126158876, -1.21786737232628), tolerance = 1e-5)
  expect_equal(par_z0$Std_Coefficient[-1] * sd(iris$Sepal.Length), par_z2$Std_Coefficient[-1], tolerance = 1e-5)
