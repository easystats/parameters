...
if (.runThisTest &&
  ...
  test_that("print-model_parameters", {
    ...
    expect_equal(
      out,
      c("# Fixed Effects (Count Model)", "", "Parameter   | Log-Mean |   SE |         95% CI |      z |      p",
        "----------------------------------------------------------------",
        "(Intercept) |     1.26 | 0.48 | [ 0.33,  2.19] |   2.66 | 0.008 ",
        "child       |    -1.14 | 0.09 | [-1.32, -0.96] | -12.27 | < .001",
        "camper [1]  |     0.73 | 0.09 | [ 0.55,  0.92] |   7.85 | < .001",
        "", "# Fixed Effects (Zero-Inflated Model)", "", "Parameter   | Log-Odds |   SE |         95% CI |     z |      p",
        "---------------------------------------------------------------",
        "(Intercept) |    -0.39 | 0.65 | [-1.67,  0.89] | -0.60 | 0.551 ",
        "child       |     2.05 | 0.31 | [ 1.45,  2.66] |  6.63 | < .001",
        "camper [1]  |    -1.01 | 0.32 | [-1.64, -0.37] | -3.12 | 0.002 ",
        "", "# Random Effects Variances", "", "Parameter               | Coefficient",
        "-------------------------------------", "SD (Intercept: persons) |        0.93",
        "SD (Residual)           |        1.00", "", "# Random Effects (Zero-Inflated Model)",
        "", "Parameter               | Coefficient", "-------------------------------------",
        "SD (Intercept: persons) |        1.17", "SD (Residual)           |        1.00"
      ))
  })
}
