...
test_that("model_parameters.stanreg", {
  ...
  testthat::expect_equal(c(nrow(params), ncol(params)), c(3, 26))
  ...
  testthat::expect_equal(c(nrow(params), ncol(params)), c(2, 26))
  ...
  testthat::expect_equal(c(nrow(params), ncol(params)), c(13, 26))
})
